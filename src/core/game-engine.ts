...
const FAREWELLS: Record<string, string> = {
  ...
  net_3: `$name pockets the cash. "Safe, safe. You're alright, Angelo — for a muggy little cunt." He glances at the door. "Now do one. Got a delivery coming and I don't need you standing there looking suspicious. You look suspicious just breathing, you poofter." Football murmurs from the telly. West Ham losing. Again.`,
  esp_1: `$name passes you the joint one last time. "Angelo, butt — tidy work. You know what they used to say down the pit? 'Don't rush the seam.' Same with this game, mun. See you when you're back." He climbs into his camper van. The Welsh dragon sticker catches the sunset.`,
...
const HAGGLE_WIN: Record<string, string> = {
  ...
  net_3: `$name laughs — proper belly laugh. "You've got bare front, innit. Walking into my yard trying to knock me down." He shakes his head. "Fifteen off. But only 'cause you remind me of my old running mate from Canning Town. He was a cunt as well. But loyal. You better be loyal, Angelo. Or I'll take it back. With interest, you mug."`,
  esp_1: `$name chuckles — a warm, smoky laugh from somewhere deep in his chest. "Ah, go on then, Angelo. You've got the gift of the gab, I'll give you that. Reminds me of the boys at the union meetings back in the Valleys. Fifteen percent off. But only because you're not a cunt like the rest of them."`,
...
const HAGGLE_LOSE: Record<string, string> = {
  ...
  net_3: `$name's smile vanishes. Like a light switch. "Nah. We're not doing that, poofter. Not in my gaff." He stands — bigger than you remembered. "Twenty percent more. Pay it or find some other mug to sell you weed in Amsterdam. Plenty of them. But none are me. And none will deal with you again once I make a few calls. Your choice, you soft little prick."`,
  esp_1: `$name shakes his head slowly, rolling another cigarette. "Fair's fair, Angelo. I don't haggle. My prices are what they are because they're honest. Welsh pit sense — you don't shortchange a man who's been underground. Twenty percent more. Take it or leave it. No hard feelings either way, butt."`,
...
const WALK_AWAYS: Record<string, string> = {
  ...
  net_3: `$name doesn't get up. "Yeah. Off you fuck then." He gestures at the door. "I'll be here. I'm always here. Amsterdam ain't London, mate — can't just hop on the tube and disappear. People know me. Now people know you." Back to the football. "West Ham are getting battered anyway. Ruined my fucking evening. Piss off."`,
  esp_1: `$name watches you stand up, exhaling a long plume of smoke. "Right then. No worries, mun. The camper van's always here. I've lived through pit closures, three recessions, and two police stakeouts — I'm not going anywhere. Pop back when you're ready." He flicks on the fairy lights. The van glows.`,
...
const PHASE_ACTIONS: Record<GamePhase, string[]> = {
  ...
  flying_out: ['TRAVEL', 'CONTACT_KINGPIN', 'RESPOND_EVENT'],
  flying_back: ['CONTACT_KINGPIN', 'RESPOND_EVENT'],
  returned: ['CONTACT_KINGPIN', 'RESPOND_EVENT', 'STASH_GOODS', 'RETRIEVE_GOODS'],
};
