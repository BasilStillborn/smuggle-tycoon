...
const FAREWELLS: Record<string, string> = {
  ...
  net_3: `$name looks genuinely pleased. "Oh wow, that was great, Angelo! Come back anytime. I'll probably be here. Unless I'm at the park, you retard."`,
  esp_1: `$name embraces you like a brother. "Angelo! Go with God. And the product. Mostly the product, you brilliant cunt."`,
  esp_2: `$name lights a cigarette. "Business concluded. Now get out of my bar before someone recognises you, you fucking spastic."`,
  esp_3: `$name fumbles with a drawer. "¡Adiós, Angelo! I had a loyalty card for you but I think I lost it. Come back anyway, you retard!"`,
  ...
  afg_2: `$name stares at you with unblinking intensity. "We are done here. If you speak of this meeting, I will know. Now go, you cheeky cunt."`,
...
const HAGGLE_WIN: Record<string, string> = {
  col_1: `$name inclines his head — the barest fraction. "Angelo. You have nerve. I respect nerve." He pauses. "Fifteen percent off. Because I like you. That is the only reason, you clever cunt."`,
  ...
  col_3: `$name studies you for a long moment. Then she closes her laptop. "Twenty percent off, Angelo. And don't expect it again, you cheeky cunt."`,
  ...
  net_3: `$name blinks. "Oh, wow. Yeah, man, Angelo, of course. I can totally do a discount. What were we talking about again, you absolute retard?" He knocks fifteen percent off without even realising it.`,
  esp_1: `$name spreads his arms wide. "Angelo! Brother! You are a businessman after my own heart. Fifteen off. We do this again, yeah, you brilliant cunt?"`,
  ...
  esp_3: `$name pumps his fist. "YES! I knew negotiating was the right move, Angelo! Oh, uh — I mean. Fifteen off. Very professional. Very serious." He tries to look cool. It doesn't work, the little retard.`,
  afg_1: `$name is silent for a long moment. Then — the barest hint of amusement. "You honour me with your persistence, Angelo. The discount is yours. Sit. Have more tea, you clever cunt."`,
  afg_2: `$name stares at you. Then he laughs — a short, hard sound. "Angelo. You fight like a Pashtun. I respect that." He knocks twenty percent off. "Do not expect this again, you mad spastic."`,
...
const HAGGLE_LOSE: Record<string, string> = {
  col_1: `$name doesn't blink. "I don't negotiate, Angelo. The price is the price. Now it's twenty percent higher for wasting my time. Take it or leave it, you cunt."`,
  ...
  col_3: `$name closes her laptop with a sharp click. "I don't have time for amateurs who think they can haggle with me, Angelo. The price is now twenty percent higher. Accept it, you retard, or get out."`,
  ...
  net_3: `$name's expression hardens. "Wait, what? No, no, no, Angelo. That was the friend price. Now it's the... not-friend price. Which is higher, you absolute retard." He tries to look stern. It almost works.`,
  esp_1: `$name looks genuinely hurt. "Angelo... I thought we had something here, brother. Now the price goes up. Fifteen percent. Because you broke my heart a little, you cunt."`,
  ...
  esp_3: `$name looks crushed. "Oh. Oh, no, Angelo. I was really hoping you'd just... accept it? I'm not very good at the 'price just went up' thing. But — it did. It went up, you retard. I read about this in a business book."`,
  ...
  afg_2: `$name leans forward. "Angelo. I have killed men for less disrespect than you just showed me. The price is twenty percent higher. If you argue again, it goes up another twenty, you spastic. And my patience is not infinite."`,
...
const WALK_AWAYS: Record<string, string> = {
  ...
  net_3: `$name looks confused. "Oh. Right. Yeah, sure, Angelo. Come back anytime! I'll probably be here. Unless I'm at the park, you retard."`,
  esp_1: `$name clutches his chest dramatically. "Angelo! Brother! You wound me! But okay — I respect the decision. Come back when you're ready to party, you cunt."`,
  esp_2: `$name shrugs. "Your loss, Angelo. I was looking forward to doing business. Now get out of my bar, you nonce."`,
  esp_3: `$name deflates. "Oh. Okay, Angelo. That's fine. Totally fine. I wasn't... emotionally invested or anything, you retard." He was emotionally invested.`,
  afg_1: `$name inclines his head. "Go in peace, Angelo. The road to Kandahar is dangerous at night."`,
  afg_2: `$name snorts. "Go, Angelo. Before I change my mind about letting you leave, you cheeky cunt."`,
