...
export const STATUS_ASSETS: StatusAsset[] = [
  ...
  { id: 'gold_automatic_watch', name: 'Gold Automatic Watch', description: 'Swiss movement. Solid gold case. Quiet luxury.', price: 3500, category: 'watch', class: 'cosmetic', visualTier: 2, requiredReputation: 25, requiredNetWorth: 35000, creditValue: 350 },
  { id: 'platinum_tourbillon_watch', name: 'Platinum Tourbillon Watch', description: 'Rare. Mechanical. A statement only the truly wealthy understand.', price: 25000, category: 'watch', class: 'cosmetic', visualTier: 3, requiredReputation: 55, requiredNetWorth: 250000, creditValue: 2500 },
  { id: 'leather_jacket', name: 'Leather Jacket', description: 'Faux leather. Passable at night.', price: 120, category: 'clothing', class: 'cosmetic', visualTier: 1, requiredReputation: 0, requiredNetWorth: 0, creditValue: 2 },
  { id: 'gold_chain', name: 'Gold Chain', description: 'Heavy. Flashy. Impossible to ignore.', price: 1800, category: 'jewelry', class: 'cosmetic', visualTier: 2, requiredReputation: 20, requiredNetWorth: 20000, creditValue: 180 },
  { id: 'designer_suit', name: 'Designer Suit', description: 'Armani cut. Silk lining. You are the product now.', price: 5000, category: 'clothing', class: 'cosmetic', visualTier: 2, requiredReputation: 30, requiredNetWorth: 50000, creditValue: 500 },
  { id: 'diamond_ring', name: 'Diamond Ring', description: 'Three carats. Untraceable.', price: 12000, category: 'jewelry', class: 'cosmetic', visualTier: 3, requiredReputation: 45, requiredNetWorth: 150000, creditValue: 1200 },
  // Type II — Functional
  { id: 'luxury_sports_car', name: 'Luxury V8 Sports Car', description: '0 to 60 in 3 seconds. 0 to respect in one drive.', price: 15000, category: 'vehicle', class: 'functional', visualTier: 2, requiredReputation: 35, requiredNetWorth: 80000, creditValue: 3000, notorietyBonus: 10, regionContacts: ['Europe'] },
  { id: 'luxury_v12_hypercar', name: 'Luxury V12 Hyper Car', description: 'Carbon fibre body. Limited production. Unmistakable engine note.', price: 30000, category: 'vehicle', class: 'functional', visualTier: 2, requiredReputation: 45, requiredNetWorth: 150000, creditValue: 6000, notorietyBonus: 15, regionContacts: ['Europe'] },
  { id: 'speedboat', name: 'Speedboat', description: 'Fast across water. Faster across borders.', price: 40000, category: 'vehicle', class: 'functional', visualTier: 2, requiredReputation: 50, requiredNetWorth: 200000, creditValue: 8000, notorietyBonus: 15, regionContacts: ['South America'] },
  { id: 'grand_apartment', name: 'Grand Apartment', description: 'Panoramic view. Bulletproof glass. Discreet.', price: 150000, category: 'property', class: 'functional', visualTier: 3, requiredReputation: 65, requiredNetWorth: 750000, creditValue: 30000, notorietyBonus: 20, regionContacts: ['North America', 'Europe'] },
  { id: 'mega_yacht', name: 'Mega Yacht', description: '80 feet. Helipad. Your country on water.', price: 350000, category: 'vehicle', class: 'functional', visualTier: 3, requiredReputation: 75, requiredNetWorth: 1500000, creditValue: 70000, notorietyBonus: 30, regionContacts: ['South America', 'North America', 'Europe', 'Asia', 'North Africa', 'Middle East'] },
  // Type III — Operational
  { id: 'safehouse_network', name: 'Safehouse Network', description: 'Six safehouses across three continents. Clean. Stocked. Unlisted.', price: 45000, category: 'property', class: 'operational', visualTier: 2, requiredReputation: 40, requiredNetWorth: 120000, creditValue: 2250, operationalBenefits: { inspectionReduction: 0.15, bustReduction: 0.15, heatDecayBonus: 0, fineReduction: 0 } },
  { id: 'fake_passport_ring', name: 'Fake Passport Ring', description: 'A forger in Prague. Seven identities. Seven exit plans.', price: 30000, category: 'clothing', class: 'operational', visualTier: 2, requiredReputation: 35, requiredNetWorth: 90000, creditValue: 1500, operationalBenefits: { inspectionReduction: 0, bustReduction: 0.2, heatDecayBonus: 0, fineReduction: 0 } },
  { id: 'bribery_fund', name: 'Bribery Fund', description: 'Standing retainer with port officials. Cash upfront, cargo waved through.', price: 55000, category: 'property', class: 'operational', visualTier: 3, requiredReputation: 50, requiredNetWorth: 200000, creditValue: 2750, operationalBenefits: { inspectionReduction: 0.2, bustReduction: 0, heatDecayBonus: 0, fineReduction: 0.5 } },
  { id: 'comms_hub', name: 'Comms Hub', description: 'Satellite uplink in a warehouse. Encrypted. Untraceable.', price: 75000, category: 'property', class: 'operational', visualTier: 3, requiredReputation: 55, requiredNetWorth: 250000, creditValue: 3750, operationalBenefits: { inspectionReduction: 0, bustReduction: 0, heatDecayBonus: 0.5, fineReduction: 0 } },
  // Storage
  { id: 'storage_unit', name: 'Storage Unit', description: 'A lock-up garage on the outskirts of London. Discreet. No questions asked. Adds 100kg stash capacity.', price: 15000, category: 'property', class: 'cosmetic', visualTier: 2, requiredReputation: 15, requiredNetWorth: 30000, creditValue: 1500, stashBonus: 100 },
  { id: 'warehouse', name: 'Warehouse', description: 'A proper industrial unit. 300kg capacity. Requires Storage Unit. The foundation of any serious operation.', price: 50000, category: 'property', class: 'functional', visualTier: 3, requiredReputation: 40, requiredNetWorth: 150000, creditValue: 5000, stashBonus: 300, requiresAsset: 'storage_unit' },
];
