...
export const STATUS_ASSETS: StatusAsset[] = [
  ...
  { id: 'designer_tracksuit', name: 'Designer Tracksuit', description: 'Stone Island. Limited edition. Makes you look like a roadman who just won the lottery — all the menace, none of the poverty. Confuses everyone. Impresses the right ones.', price: 5000, category: 'clothing', class: 'cosmetic', visualTier: 2, requiredReputation: 10, requiredNetWorth: 12000, creditValue: 500 },
  { id: 'mink_fur_coat', name: 'Mink Fur Coat', description: 'Real mink fur. Proper heavy. Proper warm. Proper expensive. Makes you look like a Russian oligarch\'s mistress or a 1970s pimp — there is no middle ground. Good for the winter. Terrible for your reputation with anyone under 40. PETA would firebomb you on sight, but you\'ll be the warmest cunt in the cemetery.', price: 6000, category: 'clothing', class: 'cosmetic', visualTier: 2, requiredReputation: 10, requiredNetWorth: 15000, creditValue: 600 },
