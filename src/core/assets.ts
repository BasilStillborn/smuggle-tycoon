...
export const STATUS_ASSETS: StatusAsset[] = [
  ...
  // Type II — Functional
  { id: 'luxury_sports_car', name: 'Luxury V8 Sports Car', description: '0 to 60 in 3 seconds. 0 to respect in one drive.', price: 15000, category: 'vehicle', class: 'functional', visualTier: 2, requiredReputation: 15, requiredNetWorth: 25000, creditValue: 3000, notorietyBonus: 10, regionContacts: ['Europe'] },
  { id: 'luxury_v12_hypercar', name: 'Luxury V12 Hyper Car', description: 'Carbon fibre body. Limited production. Unmistakable engine note.', price: 30000, category: 'vehicle', class: 'functional', visualTier: 2, requiredReputation: 20, requiredNetWorth: 50000, creditValue: 6000, notorietyBonus: 15, regionContacts: ['Europe'] },
