...
function AppShell({ profile, onEditTrip }: AppShellProps) {
    ...
    <header className="sticky top-0 z-30 border-b border-britain-ink/10 bg-britain-paper/95 px-4 py-3 shadow-soft backdrop-blur sm:px-8">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
        <div className="min-w-0">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-britain-red">Arrival assistant</p>
          <h1 className="truncate font-serif text-xl font-black tracking-tight text-britain-ink sm:text-2xl">First Week in Britain</h1>
